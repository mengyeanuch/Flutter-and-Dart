class MyDuration {
  ...
  MyDuration.fromHours(int hours) : this._(hours * 60 * 60 * 1000);
  MyDuration.fromMinutes(int minutes) : this._(minutes * 60 * 1000);
  MyDuration.fromSeconds(int seconds) : this._(seconds * 1000);
